    ...
    <head>
            ...
            $(document).ready(function () {
                ...
                $("#myTable").on("click", "tr td:nth-child(10)", function () {
                    if (confirm("是否要賣出？")) {
                        ...
                        $.ajax({
                            url: "/SpringMVC_20191128_JPA/mvc/portfolio/order/sell/" + po_id + "/" + amount,
                            type: "GET",
                            async: true,
                            cache: false,
                            processData: false, //To avoid making query String instead of JSON
                            success: function (resposeJsonObject) {
                                $.get("/SpringMVC_20191128_JPA/mvc/portfolio/investor/" + investor_id, function (data, status) {
                                    update();
                                });
                ...
                $("#myTable").on("click", "tr td:nth-child(11)", function () {
                    ...
                    if (confirm("是否要加碼買進？")) {
                        ...
                        $.ajax({
                            url: "/SpringMVC_20191128_JPA/mvc/portfolio/order/buy/" + tstock_id + "/" + amount,
                            type: "GET",
                            async: true,
                            cache: false,
                            processData: false, //To avoid making query String instead of JSON
        ...
        <script>
            ...
            function chart(investor_id) {
                ...
                $.ajax({
                    url: "/SpringMVC_20191128_JPA/mvc/portfolio/chart/asset/" + investor_id,
                    type: "GET",
                ...
                $.ajax({
                    url: "/SpringMVC_20191128_JPA/mvc/portfolio/chart/profit/" + investor_id,
                    type: "GET",
                    contentType: "application/json; charset=utf-8",
                    async: true,
                    cache: false,
