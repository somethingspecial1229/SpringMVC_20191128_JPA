        ...
        <script>
            $(document).ready(function () {
                $("#myTable").on("click", "tr", function () {
                    ...
                    //console.log(id);
                    $.get("/SpringMVC_20191128_JPA/mvc/portfolio/classify/" + id, function (data, status) {
                ...
                $("#add").on("click", function () {
                    ...
                    console.log(jsonStr);
                    $.ajax({
                        url: "/SpringMVC_20191128_JPA/mvc/portfolio/classify/",
                        type: "POST",
                ...
                $("#upt").on("click", function () {
                    ...
                    console.log(jsonStr);
                    $.ajax({
                        url: "/SpringMVC_20191128_JPA/mvc/portfolio/classify/" + jsonObj.id,
                        type: "PUT",
                        contentType: "application/json; charset=utf-8",
                        data: jsonStr,
                        async: true, 
                ...
                $("#del").on("click", function () {
                    ...
                    $.ajax({
                        url: "/SpringMVC_20191128_JPA/mvc/portfolio/classify/" + id,
                        type: "DELETE",
                        async: true,
                        cache: false,
                        processData: false,
