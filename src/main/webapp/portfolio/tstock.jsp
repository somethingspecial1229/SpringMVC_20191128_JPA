        ...
        <script>
            $(document).ready(function () {
                $("#myTable").on("click", "tr", function () {
                    ...
                    //console.log(id);
                    $.get("/SpringMVC_20191128_JPA/mvc/portfolio/tstock/" + id, function (data, status) {
                ...
                $("#add").on("click", function () {
                    ...
                    $.ajax({
                        url: "/SpringMVC_20191128_JPA/mvc/portfolio/tstock/",
                        type: "POST",
                ...
                $("#del").on("click", function () {
                    ...
                    $.ajax({
                        url: "/SpringMVC_20191128_JPA/mvc/portfolio/tstock/" + id,
                        type: "DELETE",
                        async: false, //Cross-domain requests and dataType: "jsonp" requests do not support synchronous operation
                        cache: false, //This will force requested pages not to be cached by the browser  
                        processData: false, //To avoid making query String instead of JSON
            ...
            function classify_list() {
                $.get("/SpringMVC_20191128_JPA/mvc/portfolio/classify/", function (datas, status) {
