        ...
        <script>
            ...
            $(document).ready(function () {
                $("#upt").on("click", function () {
                    ...
                    $.ajax({
                        url: "/SpringMVC_20191128_JPA/mvc/portfolio/watch/" + watch_id,
                        type: "PUT",
                ...
                $("#myTable1").on("click", "tr td:nth-child(5)", function () {
                    ...
                    if (confirm("是否要刪除？" + tstock_id)) {
                        $.ajax({
                            url: "/SpringMVC_20191128_JPA/mvc/portfolio/watch/" + watch_id + "/remove/" + tstock_id,
                            type: "DELETE",
                            async: true,
                            cache: false,
                            processData: false,
                ...
                $("#myTable2").on("click", "tr td:nth-child(5)", function () {
                    ...
                    if (flag && confirm("是否要增加？")) {
                        $.ajax({
                            url: "/SpringMVC_20191128_JPA/mvc/portfolio/watch/" + watch_id + "/add/" + tstock_id,
                            type: "GET",
                            async: true,
                            cache: false,
                            processData: false,
            ...
            function table_list1() {
                $.get("/SpringMVC_20191128_JPA/mvc/portfolio/watch/" + watch_id, function (data, status) {
            ...
            function table_list2() {
                $.get("/SpringMVC_20191128_JPA/mvc/portfolio/tstock/", function (datas, status) {
